package com.buysellrent.aspect.logger;
...
public class LogInterceptor {
	  ...
	  * @param logme
	  */
	@Before(value = "com.buysellrent.aspect.logger.LogManager.auditLog()" + "&& target(bean) "
			+ "&& @annotation(com.buysellrent.aspect.logger.Loggable)" + "&& @annotation(logme)", argNames = "bean,logme")
    ...
    * @throws Throwable
    */
	@Around(value = "com.buysellrent.aspect.logger.LogManager.performanceLog()" + "&& target(bean) "
			+ "&& @annotation(com.buysellrent.aspect.logger.Loggable)" + "&& @annotation(logme)", argNames = "bean,logme")
