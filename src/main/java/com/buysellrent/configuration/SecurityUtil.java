package com.buysellrent.configuration;
...
public class SecurityUtil {
	...
	public static void sendError(HttpServletResponse response, Exception exception, int status, String message)
		...
		ErrorResponse error = new ErrorResponse(message,false);
		error.setError(exception);
		writer.write(mapper.writeValueAsString(Util.constructJSON( error)));
		writer.flush();
		writer.close();
	}
